...
func main() {
	...
	var temp = baseStruct.Add(1, 2) //调用baseStruct中的Add函数
	/*
		所用函数
	...
	*/
	...
	mySlice6 = append(mySlice6, mySlice7...) //因为mySlice6每个元素都是int类型,所以也要将mySlice7打散成int后才能添加，否则编译错误
